            ...
            <div className="flex-1 flex flex-col gap-3 px-3 py-2">
                ...
                <div className="w-full text-white flex-1 flex items-center gap-3">
                    ...
                    <div className="text-white flex flex-col flex-1 items-center justify-center gap-2">
                        ...
                        <h4 className="font-light drop-shadow-md text-base">Total ECTS</h4>
                    </div>
                </div>

                {/* Course */}
                <div className="w-full text-white flex-1 flex flex-col justify-center">
                    <h5 className="text-base opacity-75 drop-shadow-md">Bachelor's Degree</h5>
                ...
                <div className="w-full text-white flex-1 flex items-center">
                    <div>
                        <h5 className="text-base drop-shadow-md">Status</h5>
                        <h2 className="text-3xl 2xl:text-4.5xl drop-shadow-md">Regular</h2>
                    </div>
                    <div className="flex-1 text-end">
                        <h5 className="text-base drop-shadow-md">Avg. Grade</h5>
                        <h2 className="text-3xl 2xl:text-4.5xl drop-shadow-md">13<span className="opacity-40">.37</span></h2>
                    </div>
                </div>
