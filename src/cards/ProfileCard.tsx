  ...
  return (
    <div className='flex w-full h-52 p-4 gap-4 card text-white'>
      ...
      <div className='h-full flex flex-col items-center justify-between'>
        <img className='aspect-square w-28 rounded-md flex items-center justify-center object-cover object-center' src={Avatar} />
      ...
      <div className='flex flex-col flex-1 h-full gap-2 justify-between'>
          ...
          <h1 className='text-5xl font-medium tracking-tight'>Frederico Silva</h1>
