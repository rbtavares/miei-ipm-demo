  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: "flex",
        head_cell:
          "rounded-md w-9 font-normal text-[0.8rem] dark:text-neutral-400",
        ...
        day_selected: "bg-white text-black rounded-md hover:bg-gray-200 focus:bg-gray-200",
        day_today: "rounded-full border-2 border-accent text-accent-foreground",
        day_outside:
