...
const HomePage = () => {
  const [hasRegisteredInCourses, setRegisteredInCourses] = useState(false);
          ...
          <div className="flex flex-1 flex-col gap-2 2xl:gap-5 col-span-2">
            ...
            <div className="flex flex-1 gap-2 2xl:gap-5 max-h-96">
              ...
              <div className="flex flex-1">
                <Calendar hasRegisteredInCourses={hasRegisteredInCourses}/>
              </div>
            </div>

            <div className="flex flex-1">
              <Courses setRegisteredInCourses={setRegisteredInCourses}/>
            </div>
